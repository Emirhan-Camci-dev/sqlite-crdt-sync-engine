...
exports.SYNC_STATE_TABLE = exports.SYNC_OPERATIONS_TABLE = void 0;
exports.initializeSyncTables = initializeSyncTables;
exports.trackTable = trackTable;
exports.SYNC_OPERATIONS_TABLE = '_sync_operations';
exports.SYNC_STATE_TABLE = '_sync_state';
/**
 * Initializes the required tracking tables in the SQLite database.
 */
async function initializeSyncTables(db) {
    await db.execAsync(`
    CREATE TABLE IF NOT EXISTS ${exports.SYNC_OPERATIONS_TABLE} (
    ...
    CREATE TABLE IF NOT EXISTS ${exports.SYNC_STATE_TABLE} (
 ...
 */
async function trackTable(db, tableName, columns) {
    ...
    BEGIN
      INSERT INTO ${exports.SYNC_OPERATIONS_TABLE} (id, tableName, operation, hlc, data)
